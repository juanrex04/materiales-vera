-- ============================================================
-- MATERIALES VERA - ESQUEMA DE BASE DE DATOS
-- Motor: MySQL 8+
-- Uso:  mysql -u <usuario> -p < database.sql
-- ============================================================

CREATE DATABASE IF NOT EXISTS materiales_vera
...
-- Los valores fecha y hora se llenan solos con la fecha/hora del servidor.
-- ------------------------------------------------------------
