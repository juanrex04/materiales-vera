                ...
                <form @submit.prevent="guardarVehiculo">
                    <div class="form-grid">
                        ...
                        <div class="fecha-input-wrapper">
                            ...
                            <input type="date" v-model="formulario.fecha_soat" class="fecha-input" required />
                        </div>
                        <div class="fecha-input-wrapper">
                            <label>Fecha Tecnomecánica:</label>
                            <input type="date" v-model="formulario.fecha_tecnomecanica" class="fecha-input" required />
                        </div>
                        <div class="fecha-input-wrapper">
                            <label>Último Cambio de Aceite:</label>
                            <input type="date" v-model="formulario.fecha_ultimo_cambio_aceite" class="fecha-input" required />
                        </div>
                    </div>
